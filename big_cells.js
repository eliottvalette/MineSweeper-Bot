...
(function() {
    ...
    function layoutRedCells() {
        ...
        sorted.forEach((el, i) => {
            ...
            el.style.zIndex = String(10000 + i); // i croît avec le rank → au-dessus
